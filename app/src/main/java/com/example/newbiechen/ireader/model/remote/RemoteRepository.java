...
public class RemoteRepository {
    ...
    /**
     * 返回我们的章节列表，本来返回的是一个BookChapterPackage对象
     * Single只会发射一个值，或者一个错误通知，而不是发射一系列的值。
     * 订阅Observable需要onNext()、onComplete()、onError()三个回调方法【在Observer中的】，
     * 而订阅Single只需要两个方法onSuccess()、onError()
     *
     * @param bookId
     * @return
     */
